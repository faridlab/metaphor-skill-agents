...
metaphor agent install --all                             # everything (40 skills + 13 agents)
...
> **Not sure which to use?** See the [lifecycle guide](docs/README.md) — it maps every skill and
...
- **40 skills** across four categories:
  - `metaphor/` (5) — Metaphor-workspace skills:
    ...
    - `chaos-engineering`: runs the post-change chaos gate on a workspace dev stack — fault experiments proving steady state holds and recovery is clean, with the safety rules, verdict reading, the steady-state hook and the experiment shape.
  - `generic/` (5) — portable Backbone-adjacent skills: commit-generator, grouped-commits, cloud-infrastructure-architect, domain-specific-expert, orchestrate-agents
