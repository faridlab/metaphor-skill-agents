...
This plugin bundles skill and agent content authored by others. Licenses are reproduced in `LICENSE-THIRD-PARTY`.

## `assets/skills/community/` — 21 skills
...
- Original framing and scope (diff-focused, exploit-focused, match-the-project)
- Additional structure and rules from the external versions (severity tables, scenario coverage, prove-it pattern, verification sections)
